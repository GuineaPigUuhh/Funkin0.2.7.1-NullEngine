...
class Controls extends FlxActionSet
{
	...
	public function loadKeyBinds()
	{
		...
		inline bindKeys(Control.UP, getInputs("up"));
		inline bindKeys(Control.DOWN, getInputs("down"));
		inline bindKeys(Control.LEFT, getInputs("left"));
		inline bindKeys(Control.RIGHT, getInputs("right"));
		inline bindKeys(Control.ACCEPT, [Z, ENTER]);
		inline bindKeys(Control.BACK, [BACKSPACE, ESCAPE]);
		inline bindKeys(Control.PAUSE, [ENTER, ESCAPE]);
	}

	function getInputs(name:String)
	{
		return ClientPrefs.controls.get(name);
	}
