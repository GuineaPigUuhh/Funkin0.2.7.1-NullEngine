...
class Appearance extends MusicBeatSubstate
{
			...
			case "Bool":
				{
					switch (newOptions[curSelected][0])
					{
						...
						case "Arrow Opacity Original":
							{
								Save.staticArrowsAlpha = !Save.staticArrowsAlpha;
							}
						case "Arrow Sustain Opacity Original":
							{
								Save.susArrowsAlpha = !Save.susArrowsAlpha;
							}
						default:
	...
	function updatePrefs()
	{
		newOptions = [
			...
			["Arrow Opacity Original", Save.staticArrowsAlpha, "Bool"],
			["Arrow Sustain Opacity Original", Save.susArrowsAlpha, "Bool"]
		];
	}
