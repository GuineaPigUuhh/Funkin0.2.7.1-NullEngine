...
import game.sprites.BackgroundDancer;
import game.sprites.BackgroundGirls;
...
class PlayState extends MusicBeatState
{
	...
	function setFNFvars(scripts:Array<Dynamic>)
	{
		for (i in scripts)
		{
			if (Std.isOfType(i, NullScript) || Std.isOfType(i, Script) || Std.isOfType(i, ScriptPack) || Std.isOfType(i, Stage))
			{
